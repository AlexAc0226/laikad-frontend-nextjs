...
const metricOptions = [
  ...
  { key: "PayableEvent", label: "Payable Events" },
  { key: "REVENUE", label: "Revenue" },
];

interface ChartSuppliersDonutProps {
  campaigns: any[];
}

const ChartSuppliersDonut: React.FC<ChartSuppliersDonutProps> = ({ campaigns }) => {
...
export default ChartSuppliersDonut;